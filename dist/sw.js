...
self.addEventListener('fetch', function (event) {
  var request = event.request; //diferente de get no hacemos nada y salimos
  ...
  return regeneratorRuntime.async(function precache$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 2:
          cache = _context.sent;
          cache.addAll(['/common/reproductor.html', '/js/MediaPlayer.js', '/js/reproductor.js', '/js/plugins/AutoPause.js', '/js/plugins/AutoPlay.js', '/video/music_start.mp4', '/css/styles.css']);
